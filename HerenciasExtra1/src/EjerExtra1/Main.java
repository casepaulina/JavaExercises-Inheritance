...
Para cada Alquiler se guarda: el nombre, documento del cliente, la fecha de alquiler, fecha de
...
import EjerExtra1.Entidades.Barco;
import EjerExtra1.Entidades.Alquiler;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        a1.crearCliente();
        a1.crearFecha();
        a1.calcularDiasAlquilado(LocalDate.MAX, LocalDate.MAX);
